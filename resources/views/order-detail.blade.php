                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-4 bg-white">
                        <div class="mb-4 pb-3 border-bottom">
                            <h6 class="fw-bold text-muted text-uppercase small">{{ __('orderHistory.merchant') }}</h6>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="{{ asset($item->menu_item->image) }}" class="rounded-3 shadow-sm" style="width: 60px; height: 60px; object-fit: cover;">
