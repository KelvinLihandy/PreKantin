...
<div class="container-fluid min-vh-100 py-5" style="background-color: #C9E2FE;">
    <div class="container">
        <div class="bg-white p-4 rounded-4 shadow-sm mb-4">
            <h2 class="fw-bold m-0">Pesanan Anda</h2>
        </div>

        @if($groupedOrders->isEmpty())
            <div class="text-center py-5">
                <h4 class="text-muted">Belum ada riwayat pesanan.</h4>
                <a href="{{ route('home.page') }}" class="btn btn-primary mt-3">Pesan Sekarang</a>
            </div>
        @else
                                                ...
                                                <div class="row h-100 align-items-stretch">
                                                    ...
                                                    <div class="col-md-8 d-flex flex-column justify-content-between">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-1 fw-bold">Total Harga : Rp. {{ number_format($order->total_price, 2, ',', '.') }}</p>
                                                            <p class="mb-1 text-muted">Merchant : {{ $order->merchant->user->name ?? 'Merchant' }}</p>
                                                            <p class="mb-1 text-muted">Waktu : {{ $order->order_time->format('d F H:i') }}</p>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 d-flex justify-content-md-end align-items-center mt-3 mt-md-0">
                                                        @if($order->orderItems->isNotEmpty())
                                                            ...
                                                            <div class="card border border-2 border-dark rounded-4 overflow-hidden bg-white shadow-sm" 
                                                                ...
                                                                <div style="height: 120px; overflow: hidden;">
                                                                    <img src="{{ asset($firstItem->menu_item->image) }}" 
                                                                         class="w-100 h-100" 
                                                                ...
                                                                <div class="card-body p-2 d-flex flex-column justify-content-between" style="min-height: 110px;">
                                                                    ...
                                                                    <h6 class="fw-bold mb-2 text-start" 
                                                                        style="color: #FB8C30; font-size: 0.9rem; line-height: 1.2; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                                        ...
                                                        @else
                                                            <div class="d-flex align-items-center justify-content-center border rounded bg-light text-muted small" 
